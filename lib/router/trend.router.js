...
trendRouter.put('/:trend_id', verifyPermission('user_trend', 'trend_id'), verifyParams(posttrend_schema), trendPut);
trendRouter.delete('/:trend_id', verifyPermission('user_trend', 'trend_id'), trendDelete);
